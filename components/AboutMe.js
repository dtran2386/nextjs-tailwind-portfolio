...
export default function AboutMe() {
  return (
    <section className="bg-white dark:bg-gray-700">
      <div className="max-w-6xl mx-auto h-48 bg-white dark:bg-gray-700">
        <h1 className=" text-5xl md:text-9xl font-bold py-20 text-center md:text-left">
          About Me.
        </h1>
      </div>
      <div className="bg-[#F1F1F1] -mt-10 dark:bg-gray-700">
      ...
      <div className="bg-[#F1F1F1] dark:bg-gray-800 px-4">
          ...
          <div className="inline-flex flex-col">
            <div>
              ...
              <p className="text-lg text-gray-500 mt-4 dark:text-gray-300">
                ...
                and I'll get back to you when I'm able.
              </p>
            </div>
            <div className="mt-8">
              <h1 className="text-xl font-semibold text-gray-700 dark:text-gray-200">
              ...
              <p className="text-lg text-gray-500 mt-4 dark:text-gray-300">
                I'm currently in the market for a new job, so check out my{" "}
                <a
